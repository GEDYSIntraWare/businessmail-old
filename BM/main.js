...
class ConnectorFactory {
    constructor(globals, message, auth, waitlist, connection) {
        this.globals = globals;
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_7__.Observable((observer) => {
            try {
                ...
                if (sessionStorage.getItem('verseAppData') != null) {
                    const verse = new _connector_verse_service__WEBPACK_IMPORTED_MODULE_1__.ConnectorVerseService(this.globals, this.message, this.connection);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ 9165);
/* harmony import */ var _connector_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./connector.service */ 3529);
/* harmony import */ var sanitize_html__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! sanitize-html */ 17);
...
/* harmony import */ var _message_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../message.service */ 2684);
/* harmony import */ var _connection_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../connection.service */ 2377);
...
class ConnectorVerseService extends _connector_service__WEBPACK_IMPORTED_MODULE_0__.ConnectorService {
    constructor(globals, messageService, connection) {
        super(globals);
        this.messageService = messageService;
        this.connection = connection;
    ...
    getPostData() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            this.connection.getReq('user', null, true).subscribe((resp) => {
                ...
                const body = context.body.replace(/<br\s*\/?>/g, '\n');
                this.postData = {
                    ...
                    body,
                    preview: sanitize_html__WEBPACK_IMPORTED_MODULE_6__(body),
                    ...
                    isIncoming: resp.mail.toLowerCase() ===
                        ...
                        resp.mail.toLowerCase() === context.sender.notesAddress.toLowerCase()
                        ? false
                        : true,
                };
...
ConnectorVerseService.ɵfac = function ConnectorVerseService_Factory(t) { return new (t || ConnectorVerseService)(_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_globals_service__WEBPACK_IMPORTED_MODULE_1__.GlobalsService), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_message_service__WEBPACK_IMPORTED_MODULE_2__.MessageService), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_connection_service__WEBPACK_IMPORTED_MODULE_3__.ConnectionService)); };
ConnectorVerseService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineInjectable"]({ token: ConnectorVerseService, factory: ConnectorVerseService.ɵfac, providedIn: 'root' });
